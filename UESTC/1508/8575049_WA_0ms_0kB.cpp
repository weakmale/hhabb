...
int main(){
    ...
    if(n==1){
        ...
        if(lt<l) printf("%.4lf %.4lf %.4lf",lt,xi,yi);
        else{
            if(l1>=l2&&l1>=l3) printf("%.4lf %.4lf %.4lf",l1,(x1+x2)/2,(y1+y2)/2);
            else if(l2>=l1&&l2>=l3) printf("%.4lf %.4lf %.4lf",l2,(x1+x3)/2,(y1+y3)/2);
            else if(l3>=l1&&l3>=l2) printf("%.4lf %.4lf %.4lf",l3,(x3+x2)/2,(y3+y2)/2);
        }
    }
    puts("");
    return 0;
